        ...
        <form method="POST" action="/store_cart" id="store_cart">
            ...
            <div class="collection-wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="{{ url('assets/images/products/' . $product->product_image) }}" style="width: 100%; object-fit: cover !important;" alt="">
                        </div>
                            ...
                            <div class="product-right">
                                ...
                                <div class="qty-box my-2">
                                    <div class="input-group justify-content-lg-start justify-content-md-center">
                                        ...
                                        <span class="input-group-prepend">
                                            <button type="button" class="btn" onclick="setAddQuantity('{{ $product->stock }}')">
                                ...
                                <div class="form-group col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" readonly name="daterange" value="" placeholder="Select Dates" class="form-control" />
                                    <input type="hidden" name="start_date" value="{{ $cart ? $cart->start_date : null }}">
                                    <input type="hidden" name="end_date" value="{{ $cart ? $cart->end_date : null }}">
                                </div>
                                <h4>Total Days: <span class="total_date_count">{{ $cart ? $cart->total_date : null }}</span></h4>
                                <br>
                                <div class="product-buttons">
                                    ...
                                    @if($product->stock > 0)
                                        ...
                                        @else
                                            <button type="submit" id="cartEffect" class="btn btn-solid hover-solid btn-animation">
                                                <i class="fa fa-shopping-cart me-1" aria-hidden="true"></i> Borrow This Item
                                            </button>
                                        @endif
                                    @else
                                        <button type="button" disabled id="cartEffect" class="btn btn-solid hover-solid btn-secondary btn-animation">
                                            Out of Stock
                                        </button>
                                    @endif
                                </div>
                    ...
                    <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                        <li class="nav-item"><a class="nav-link active" id="review-top-tab" data-bs-toggle="tab"
                                href="#top-review" role="tab" aria-selected="false"><i
                                    class="icofont icofont-contacts"></i>Reviews ({{$product->reviews->count()}})</a>
    ...
    <div class="container mt-5 p-3 rounded" style="background-color: #038dcc;">
        <div class="row">
            ...
            <div class="col-md-3 d-flex justify-content-center align-items-center">
                <a href="/store/vendor/{{ $product->vendor->id }}" class="btn btn-solid btn-air-primary">Visit Vendor Shop</a>
            </div>
        </div>
    </div>
       ...
       rates.forEach((rate) => {
        ...
        $(function() {
                ...
                $('input[name="daterange"]').daterangepicker({
                    ...
                    minDate: new Date(),
                    startDate: startDate ? startDate : $(this).val(' '), // after open picker you'll see this dates as picked
