                                ...
                                <div class="digital-add needs-validation">
                                    @if(session()->get('role') == 'admin')
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select form-control select2" name="vendor_id" oninput="findVendor(this)">
                                                @foreach($vendors as $vendor) 
                                                    <option value="{{ $vendor->id }}" {{ session()->get('id') == $vendor->id ? 'selected' : null }}>{{ $vendor->email }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    @else
                                        <input type="hidden" name="vendor_id" value="{{ session()->get('id') }}">
                                    @endif
                                    <div class="form-group">
                                        <label
